  ...
  const rights = [
    {
      ...
      desc: "Art. 15 DSGVO",
      content:
        "Sie haben das Recht, eine Bestätigung darüber zu verlangen, ob betreffende Daten verarbeitet werden und auf Auskunft über diese Daten sowie auf weitere Informationen und Kopie der Daten gemäß den gesetzlichen Vorgaben.",
    },
    {
      label: "Berichtigung",
    ...
    },
    {
      ...
      desc: "Art. 17 DSGVO",
      content:
        "Sie haben das Recht zu verlangen, dass betreffende Daten unverzüglich gelöscht werden, sofern keine gesetzlichen Aufbewahrungspflichten entgegenstehen.",
    },
    {
      label: "Widerspruch",
    ...
    <div className="font-nunito mx-auto w-full max-w-7xl px-4 py-8">
      ...
      <div className="font-nunito flex flex-col items-center justify-center gap-8 py-7 text-center md:flex-row md:py-10 md:text-left">
        ...
        <p className="text-preset-4 flex max-w-3xl items-center justify-center px-4 leading-8 text-gray-600 md:px-0">
          ...
          Daten vertraulich und im Einklang mit der Datenschutz-Grundverordnung (DSGVO) sowie dem
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] border border-gray-100 bg-white p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] md:p-10">
            ...
            <div className="space-y-4">
              ...
              <p className="leading-relaxed text-gray-500 italic">
                Verantwortlich für die Datenverarbeitung auf dieser Webseite ist der Verein
                Berehynja e.V. Die vollständigen Kontaktdaten finden Sie in unserem Impressum.
              </p>
          ...
          <div className="group relative overflow-hidden rounded-[2.5rem] bg-gray-900 p-8 text-white shadow-xl">
            ...
            <p className="text-sm leading-relaxed text-gray-400 italic">
              Alle Textinhalte, Verknüpfungen und die technische Logik dieser Webseite werden über{" "}
              <strong>Firebase (Google Ireland Ltd.)</strong> verarbeitet. Die Speicherung erfolgt
          ...
          <div className="rounded-[2.5rem] border border-gray-100 bg-white p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
            ...
            <p className="font-nunito leading-7 text-gray-600 italic">
              Wir verwenden ausschließlich <strong>technisch notwendige Cookies</strong> (z.B. zur
              Speicherung der Sprachauswahl). Es werden keine Cookies zu Marketing- oder
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <p className="text-sm leading-6 italic opacity-90">
                  <strong>Cloudinary:</strong> Bilder auf dieser Seite werden zur
                  Performance-Optimierung über Cloudinary geladen.
                </p>
              </div>
              <div className="flex items-start gap-4">
                <Youtube size={20} className="mt-1 shrink-0 text-red-400" />
                <p className="text-sm leading-6 italic opacity-90">
                  <strong>YouTube:</strong> Videos werden im erweiterten Datenschutzmodus
                  eingebunden, um die Übertragung von Nutzerdaten zu minimieren.
                </p>
              </div>
            </div>
          </div>
