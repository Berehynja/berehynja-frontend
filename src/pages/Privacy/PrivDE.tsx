...
export const Privacy = () => {
  ...
  const rights = [
    { 
      ...
      icon: <Eye size={18} />, 
      desc: "Art. 15 DSGVO",
      content: "Sie haben das Recht, eine Bestätigung darüber zu verlangen, ob betreffende Daten verarbeitet werden und auf Auskunft über diese Daten sowie auf weitere Informationen und Kopie der Daten gemäß den gesetzlichen Vorgaben."
    },
    { 
      label: "Berichtigung", 
      icon: <ShieldCheck size={18} />, 
      desc: "Art. 16 DSGVO",
      content: "Sie haben das Recht, die Vervollständigung der Sie betreffenden Daten oder die Berichtigung der Sie betreffenden unrichtigen Daten zu verlangen."
    },
    { 
      label: "Löschung", 
      icon: <AlertCircle size={18} />, 
      desc: "Art. 17 DSGVO",
      content: "Sie haben das Recht zu verlangen, dass betreffende Daten unverzüglich gelöscht werden, sofern keine gesetzlichen Aufbewahrungspflichten entgegenstehen."
    },
    { 
      label: "Widerspruch", 
      icon: <ShieldAlert size={18} />, 
      desc: "Art. 21 DSGVO",
      content: "Sie haben das Recht, aus Gründen, die sich aus Ihrer besonderen Situation ergeben, jederzeit gegen die Verarbeitung der Sie betreffenden personenbezogenen Daten Widerspruch einzulegen."
    }
  ];
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 font-montserratRegular">
      ...
      {/* HEADER SECTION - Identisch mit Contact-Seite */}
      <div className="font-montserratBold flex flex-col items-center justify-center gap-8 py-7 md:flex-row md:py-10 text-center md:text-left">
        ...
        <p className="text-preset-4 flex max-w-3xl items-center justify-center px-4 leading-8 text-gray-600 md:px-0">
          Der Schutz Ihrer persönlichen Daten ist uns ein wichtiges Anliegen. Wir verarbeiten Ihre Daten vertraulich und im Einklang mit der Datenschutz-Grundverordnung (DSGVO) sowie dem Bundesdatenschutzgesetz (BDSG).
        </p>
      </div>

      <section className="grid grid-cols-1 gap-12 lg:grid-cols-2 mt-8">
        
        {/* LINKE SPALTE: VERANTWORTUNG & TECHNIK */}
        <div className="flex flex-col gap-8">
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-white p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 md:p-10">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-500 leading-relaxed italic">
                Verantwortlich für die Datenverarbeitung auf dieser Webseite ist der Verein Berehynja e.V. Die vollständigen Kontaktdaten finden Sie in unserem Impressum.
              </p>
          ...
          {/* 2. Firebase Infrastruktur */}
          <div className="rounded-[2.5rem] bg-gray-900 p-8 text-white shadow-xl relative overflow-hidden group">
            <div className="flex items-center gap-3 mb-6 text-blue-400">
              <Server size={28} />
              <h3 className="font-montserratBold text-xl uppercase tracking-tight font-bold text-white">Firebase Hosting</h3>
            </div>
            <p className="text-sm text-gray-400 leading-relaxed italic">
              Alle Textinhalte, Verknüpfungen und die technische Logik dieser Webseite werden über <strong>Firebase (Google Ireland Ltd.)</strong> verarbeitet. Die Speicherung erfolgt ausschließlich auf Servern innerhalb der EU.
            </p>
            <div className="mt-6 flex items-center gap-2 text-[10px] text-blue-300 font-bold uppercase tracking-widest border-t border-white/10 pt-4">
              <Lock size={14} className="text-green-500" /> SSL-Verschlüsselung aktiv
            </div>
          </div>
          ...
          <div className="rounded-[2.5rem] bg-white p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100">
            ...
            <p className="text-gray-600 leading-7 font-montserratRegular italic">
              Wir verwenden ausschließlich <strong>technisch notwendige Cookies</strong> (z.B. zur Speicherung der Sprachauswahl). Es werden keine Cookies zu Marketing- oder Analysezwecken eingesetzt.
            </p>
          </div>
        </div>

        {/* RECHTE SPALTE: BETROFFENENRECHTE & MEDIEN */}
        <div className="flex flex-col gap-8">
          
          {/* 4. Betroffenenrechte (Grid mit Modals) */}
          <div className="rounded-[2.5rem] bg-white p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100">
            <div className="flex items-center gap-4 mb-8 text-blue-600">
              <FileLock2 size={32} />
              <h2 className="font-montserratBold text-2xl text-gray-800 uppercase tracking-tight font-bold">Ihre Rechte</h2>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <p className="text-sm opacity-90 leading-6 italic">
                  <strong>Cloudinary:</strong> Bilder auf dieser Seite werden zur Performance-Optimierung über Cloudinary geladen.
                </p>
              </div>
              <div className="flex items-start gap-4">
                <Youtube size={20} className="text-red-400 shrink-0 mt-1" />
                <p className="text-sm opacity-90 leading-6 italic">
                  <strong>YouTube:</strong> Videos werden im erweiterten Datenschutzmodus eingebunden, um die Übertragung von Nutzerdaten zu minimieren.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-[2.5rem] bg-gray-50 p-8 border border-gray-100 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 uppercase tracking-widest leading-relaxed">
                Gemäß Art. 77 DSGVO bei der zuständigen Aufsichtsbehörde.
              </p>
            </div>
          </div>
        </div>
