...
export const Contact = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 pb-12 md:px-8">
      {/* HEADER SECTION */}
      <div className="font-nunito flex flex-col items-center justify-center gap-8 py-7 md:flex-row md:py-12">
        <div className="flex flex-col items-center justify-center text-nowrap md:items-start">
          <h1 className="text-preset-2 font-nunito flex flex-nowrap justify-center pb-4 text-4xl md:text-5xl">
            Зв'яжіться з нами
          </h1>
