          ...
          {isEditing ? (
            <div className="space-y-4 bg-slate-50 p-6 rounded-3xl border border-slate-200">
              ...
              <div className="flex gap-3">
                ...
                <button onClick={() => setIsEditing(false)} className="flex gap-1 px-6 py-3 items-center justify-center  bg-white  md:text-slate-400 rounded-xl font-bold cursor-pointer md:hover:text-slate-600 border border-slate-100">
                  <X size={18}/> Скасувати
                </button>
              </div>
            </div>
