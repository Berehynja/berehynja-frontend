  ...
  return (
    <>
      <section>
        ...
        >
          <h1 className="font-montserratBold mb-4 align-sub text-3xl text-white sm:text-4xl md:text-5xl">
            {t("home.welcome")}
          </h1>

          <p className="font-montserratRegular block w-full rounded-lg bg-black/50 p-5 indent-8 text-xl leading-8 text-white sm:text-2xl md:text-3xl md:leading-10">
            {t("home.description")}
