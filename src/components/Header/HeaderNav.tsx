...
export const HeaderNav = () => {
  ...
  const linkStyles =
    "relative before:absolute before:-bottom-2 before:left-1/2 before:h-0.5 before:w-0 before:-translate-x-1/2 before:bg-blue-700 before:transition-all hover:text-blue-700 hover:before:w-full hover:before:transition-all hover:before:duration-300 [.active>&]:text-blue-700 [.active>&]:before:w-full [.active>&]:before:transition-none [.active>&]:before:duration-300";
  ...
  return (
    <nav className="font-nunito mb-10 flex w-full flex-col items-center justify-center gap-7 text-xl text-stone-600 lg:mr-23 lg:mb-0 lg:flex-row lg:justify-end lg:gap-8 lg:px-8 lg:text-black">
      ...
      >
        <div className="flex items-center gap-1 py-2 transition-colors group-hover:text-blue-700">
          ...
          <ChevronDown
            ...
            className={`transition-transform duration-300 lg:group-hover:rotate-180 ${
              isMobileMenuOpen ? "rotate-180 text-blue-700" : ""
            }`}
          />
        </div>
        ...
        >
          <div className="flex w-full min-w-40 flex-col rounded-2xl border border-stone-100 bg-white p-4 shadow-xl lg:w-60 lg:shadow-[0_10px_30px_rgba(0,0,0,0.1)]">
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center rounded-xl py-4 transition-all lg:px-4 lg:py-3 ${
                  isActive
                    ? "bg-blue-50 font-bold text-blue-700"
                    : "text-stone-600 hover:bg-slate-50 hover:text-blue-700"
                }`
              }
            >
            ...
            <div className="mx-4 my-1 h-px bg-slate-50 lg:mx-2" />
