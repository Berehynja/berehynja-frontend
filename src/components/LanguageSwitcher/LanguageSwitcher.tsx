...
export const LanguageSwitcher = ({ variant = "light" }: LanguageSwitcherProps) => {
  ...
  return (
    <div
      ...
      className="font-nunito relative w-26 shrink-0 lg:h-7.5 lg:w-23 lg:-translate-y-1"
    >
      <div
        className={`flex w-26 flex-col gap-3 overflow-hidden rounded-xl border px-3 py-2 shadow-sm transition-[max-height] duration-300 lg:absolute lg:top-0 lg:left-0 lg:w-23 lg:rounded-sm lg:border-transparent lg:bg-white lg:px-2.5 lg:py-1.5 lg:text-slate-900 lg:shadow-none ${
