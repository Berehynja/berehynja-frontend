  ...
  return (
    <section className="my-10">
      ...
      <div className="max-w-[375px] mt-10 md:max-w-full  mx-auto grid gap-8 xl:gap-y-6 md:grid md:grid-cols-2 xl:grid-cols-4">
        ...
        <aside className="bg-Blue-2 rounded-lg p-8 flex flex-col gap-4 shadow-card relative bg-decor md:col-span-2 xl:col-span-2">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gray-100 border border-black rounded-full flex items-center justify-center">
        <HouseHeart/>
            </div>
            <div>
        ...
        <aside className="bg-Red-2 rounded-lg p-8 flex flex-col gap-4 shadow-card md:row-start-2 xl:col-start-3 xl:row-start-1">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gray-100 border border-black rounded-full flex items-center justify-center">
        <School/>
            </div>
        ...
        {/* Для спільноти */}
        <aside className="bg-Green-2 text-grey-500 rounded-lg p-8 flex flex-col gap-4 shadow-card md:row-start-2 xl:col-start-4 xl:row-start-1">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gray-100 border border-black rounded-full flex items-center justify-center">
<Users/>
            </div>
        ...
        {/* Для дорослих */}
        <aside className="bg-Cyan-2 rounded-lg p-8 flex flex-col gap-4 shadow-card md:col-span-2 xl:col-start-1 xl:row-start-2">
          <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-gray-100 border border-black rounded-full flex items-center justify-center">
        <Briefcase/>
            </div>
        ...
        {/* Підсумок */}
        <aside className="bg-Orange-2 rounded-lg p-8 flex flex-col gap-4 shadow-card md:col-span-2 xl:row-start-2 xl:col-start-3">
          <div className="flex items-center gap-4">
             <div className="w-12 h-12 bg-gray-100 border border-black rounded-full flex items-center justify-center">
        <Heart/>
            </div>  
